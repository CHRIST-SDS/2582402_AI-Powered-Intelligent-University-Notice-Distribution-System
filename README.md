...
**File:** `docs/screenshots/home_page.png`
...
![Upload Poster with Credentials](docs/screenshots/upload_poster_with_credentials.png)
...
![RAG Question Answer](docs/screenshots/rag-question_answer.png)
...
![Generated Image](docs/screenshots/generated_image.png)
...
![Send Mail](docs/screenshots/send_mail.png)

**File:** `docs/screenshots/send_mail.png`

### 12. Mail Send Confirmation

![Mail Send Confirmation](docs/screenshots/mail_send_confirmation.png)

**File:** `docs/screenshots/mail_send_confirmation.png`

### 13. Gmail Received Mail

![Gmail Received](docs/screenshots/mail_gmail_received.png)
